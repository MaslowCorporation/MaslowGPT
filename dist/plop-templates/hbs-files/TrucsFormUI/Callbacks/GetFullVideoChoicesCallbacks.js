...
export const GetFullVideoChoicesCallbacks = {
...
export const GetFullVideoChoiceValue = (value) => {
  // le nom de key du choix effectué
  const choiceKeyName = GetFullVideoChoiceKey(value);

  // le style correspondant
  const choiceCallbackValue = GetFullVideoChoicesCallbacks[choiceKeyName]();
 ...
 */
export const GetFullVideoChoiceKey = (choice) => {
