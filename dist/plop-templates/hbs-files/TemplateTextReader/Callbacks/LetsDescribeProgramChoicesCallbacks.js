...
import { LetsDescribeProgramChoices } from "../LetsDescribeProgramChoices/LetsDescribeProgramChoices";

export const LetsDescribeProgramChoicesCallbacks = {
...
export const LetsDescribeProgramChoiceValue = (value) => {
  // le nom de key du choix effectué
  const choiceKeyName = LetsDescribeProgramChoiceKey(value);

  // le style correspondant
  const choiceCallbackValue = LetsDescribeProgramChoicesCallbacks[choiceKeyName]();
 ...
 */
export const LetsDescribeProgramChoiceKey = (choice) => {
