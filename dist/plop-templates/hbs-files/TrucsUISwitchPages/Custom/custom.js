...
export const CustomComponent = ({
  ...
  const UIComponent = () =>
    <MsgFormButton
      ...
      message={"Cette UI te permet de switcher entre un mini navigateur web, et une UI de ton choix. Par ex. Ecris ta clé API ci-dessous, ou clique le bouton Souscrire pour souscrire à MaslowAPI."}
      initialFormInput={defaultAPIKey}
      formPlaceholder={"Ecris ta clé API ici"}
