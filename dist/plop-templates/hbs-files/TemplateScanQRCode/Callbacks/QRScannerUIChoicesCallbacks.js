...
import { QRScannerUIChoices } from "../QRScannerUIChoices/QRScannerUIChoices";

export const QRScannerUIChoicesCallbacks = {
...
export const QRScannerUIChoiceValue = (value) => {
  // le nom de key du choix effectué
  const choiceKeyName = QRScannerUIChoiceKey(value);

  // le style correspondant
  const choiceCallbackValue = QRScannerUIChoicesCallbacks[choiceKeyName]();
 ...
 */
export const QRScannerUIChoiceKey = (choice) => {
