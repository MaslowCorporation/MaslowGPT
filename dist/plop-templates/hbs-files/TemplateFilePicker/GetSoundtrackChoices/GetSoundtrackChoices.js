...
export const GetSoundtrackChoices = () => {
  return {
    /* PLOP_INJECT_CHOICE */
...
export const GetSoundtrackChoicesUI = () => {
  return {
 ...
 *
 **/
export const GetSoundtrackChoicesActions = {
